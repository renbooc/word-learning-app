...
export function AchievementsWall() {
    ...
    const allAchievements = useMemo(() => [
        ...
        },
        {
            id: 'streak_3',
            name: '三日连胜',
            description: '连续 3 天进行词汇练习',
            icon: FireIcon,
            solidIcon: FireSolid,
            target: 3,
            current: userProgress.bestStreak,
